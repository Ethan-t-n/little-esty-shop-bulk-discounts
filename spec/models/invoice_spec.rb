...
RSpec.describe Invoice, type: :model do
  ...
  describe 'model methods' do
    ...
    it 'returns the invoice items for the merchant on an invoice' do 
      merchant_1 = Merchant.create!(name: "Schroeder-Jerde", created_at: Time.now, updated_at: Time.now)
      ...
      expect(invoice_1.invoice_items_from_merchant(merchant_1.id)).to eq([invoice_item_1, invoice_item_2])
    end

    it 'returns the total nondiscounted revenue from invoice' do 
      merchant_1 = Merchant.create!(name: "Schroeder-Jerde", created_at: Time.now, updated_at: Time.now)
      merchant_2 = Merchant.create!(name: "Klein, Rempel and Jones", created_at: Time.now, updated_at: Time.now)
      ...
      expect(invoice_1.total_invoice_revenue(merchant_1.id)).to eq(96000)
    end
  ...
  describe 'instance methods' do 
    it 'returns the invoice items for a merchan on an invoice' do 
      merchant_1 = Merchant.create!(name: "Schroeder-Jerde", created_at: Time.now, updated_at: Time.now)
      merchant_2 = Merchant.create!(name: "Klein, Rempel and Jones", created_at: Time.now, updated_at: Time.now)
    ...
    it 'returns the discounted total for invoice' do 
      merchant_1 = Merchant.create!(name: "Schroeder-Jerde", created_at: Time.now, updated_at: Time.now)
      merchant_2 = Merchant.create!(name: "Klein, Rempel and Jones", created_at: Time.now, updated_at: Time.now)
      ...
      discount_1 = Discount.create!(percent: 10, quantity_threshold: 5, merchant_id: merchant_1.id)
      discount_2 = Discount.create!(percent: 20, quantity_threshold: 10, merchant_id: merchant_1.id)
      discount_3 = Discount.create!(percent: 10, quantity_threshold: 15, merchant_id: merchant_2.id)

      expect(invoice_1.discount_total).to eq(26700)
    end

     it 'returns the discounted total for an invoice for specific merchant' do 
      merchant_1 = Merchant.create!(name: "Schroeder-Jerde", created_at: Time.now, updated_at: Time.now)
      merchant_2 = Merchant.create!(name: "Klein, Rempel and Jones", created_at: Time.now, updated_at: Time.now)
      ...
      discount_1 = Discount.create!(percent: 10, quantity_threshold: 5, merchant_id: merchant_1.id)
      discount_2 = Discount.create!(percent: 20, quantity_threshold: 10, merchant_id: merchant_1.id)
      discount_3 = Discount.create!(percent: 10, quantity_threshold: 15, merchant_id: merchant_1.id)

      expect(invoice_1.discount_total_for_merchant(merchant_1)).to eq(19200)
    end
