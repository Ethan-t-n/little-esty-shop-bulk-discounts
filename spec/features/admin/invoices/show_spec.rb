...
RSpec.describe 'admin invoice show page' do 
    ...
    it 'has shows the total both total and discounted for an invoice ' do
        merchant_1 = Merchant.create!(name: "Schroeder-Jerde", created_at: Time.now, updated_at: Time.now)
        ...
        item_2 = Item.create!(name: "Crocs", description: "Worst and Best Shoes", unit_price: 4000, merchant_id: merchant_1.id, created_at: Time.now, updated_at: Time.now)
        item_3 = Item.create!(name: "Beanie", description: "Perfect for a cold day", unit_price: 5000, merchant_id: merchant_1.id, created_at: Time.now, updated_at: Time.now)
        item_4 = Item.create!(name: "Coat", description: "Perfect for a rainy day", unit_price: 5000, merchant_id: merchant_2.id, created_at: Time.now, updated_at: Time.now)
        ...
        discount_3 = Discount.create!(percent: 20, quantity_threshold: 10, merchant_id: merchant_2.id)
     ...
     it 'has shows the total both total and discounted for an invoice backup test ' do
        ...
        discount_2 = Discount.create!(percent: 30, quantity_threshold: 15, merchant_id: merchant_1.id)
